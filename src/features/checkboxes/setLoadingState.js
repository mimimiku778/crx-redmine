import { TAB_CONTENT_WAIT_CURSOR_STYLE, TAB_CONTENT_CURSOR_STYLE } from './constants'
...
export default function setLoadingState(loading, tabContent, checkboxes) {
  ...
  if (loading && tabContent.style.cursor === TAB_CONTENT_WAIT_CURSOR_STYLE) {
    ...
    checkboxes && checkboxes.forEach((checkbox) => (checkbox.style.cursor = tabContentCursorStyle))
    return true
  }
}
